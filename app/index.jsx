      ...
      <ScrollView contentContainerStyle={{ height: "100%" }}>
        <View className="m-2 flex justify-center items-center">
          ...
          <View className="w-3/4" >
            ...
            <TouchableOpacity onPress={() => router.push("/home")} className="p-2 my-2 border border-[#f49b33] text-black rounded-lg max-w-fit ">
          ...
          <View>
            <Text className="text-center text-base font-semibold my-4 text-white" > 
              <View className="w-24 p-2 mb-1 border-b-2 border-[#f49b33]" /> 
              {" "}or{" "} 
              <View className="border-b-2 border-[#f49b33] p-2 mb-1 w-24" /> </Text>
            <TouchableOpacity 
